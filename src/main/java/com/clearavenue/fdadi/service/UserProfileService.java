...
public class UserProfileService {
	...
	public Optional<UserProfile> findByUserId(final String username) {
		final String uri = String.format("http://localhost:8082/user/%s", username);
